...
//
//
//public class Game_Main2 { // 자동 전투 만들기
//
//
...
//                    int bosslevel = 50;
//                    if (place_n==1){
//                        wildPokemons.add(new Pidgey(level));
//                        wildPokemons.add(new Rattata(level));
////                    } else if (region==2){
////                        wildPokemons.add(new Pidgey(level));
////                        wildPokemons.add(new Rattata(level));
...
//                        wildPokemons.add(new Nidoran(level));
...
//                    // 자동 전투
//                    int skillRandomIndex = (int)(Math.random()*2+5);
